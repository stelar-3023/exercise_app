...
describe("toggleAccount", () => {
  test("toggle the account details modal open", () => {
    render(<AccountModal user={{uid: "ZDGIjt1nP1bkbU8mSqJZ3QAO8103" }} renderAccount={(toggleAccount) => (
       <button className="toggle-test" onClick={toggleAccount}>toggleAccount</button>
    )}/>);
